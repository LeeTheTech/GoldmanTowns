...
public enum SubSyntax {
  ...
  COMMAND_RENT_TRUST("/town rent trust &f<add/remove/list>"),
  COMMAND_RENT_TRUST_ADD("/town rent trust add &f<player>"),
  COMMAND_RENT_TRUST_REMOVE("/town rent trust remove &f<player>"),
