...
public enum Lang {
  ...
  KILL_DEATH_RATIO("&e{0}"),
  AUTO_EVICTED_WARNING_TARGET("&cYou have been auto evicted from chunk &3{0} &cfor insufficient funds."),
  ...
  AUTO_TAX_COLLECTION_MESSAGE_BANK("&aA total of {0} &awas withdrawn from your town bank for daily taxes."),
  AUTO_TAX_COLLECTION_MESSAGE_MAYOR("&aA total of {0} &awas withdrawn from your balance for daily taxes because your town bank had insufficient funds."),
  ...
  COMMAND_BORDER_SUCCESS("&aYou successfully toggled &3{0} &aborder {1}&a!"),
  ...
  COMMAND_INFO_TOWN_TARGET_PLAYER("&b&lTarget Player&7: {0}"),
  ...
  COMMAND_TOP_BANK_TITLE("&a------ &7[ &2&lBank Leaderboard &7] &a------"),
  COMMAND_TOP_SIZE_TITLE("&a------ &7[ &2&lSize Leaderboard &7] &a------"),
  COMMAND_TOP_BANK_LINE("&3{0}&7. &e{1} &7| {2}"),
  COMMAND_TOP_SIZE_LINE("&3{0}&7. &e{1} &7| &6{2}"),
  COMMAND_TAXES_TITLE("&a----- &7[ &2&lTown Taxes &7] &a-----"),
  COMMAND_TAXES_CLAIMS("&3&lTotal Claims&7: &6{0}"),
  COMMAND_TAXES_COST("&3&lClaim Tax&7: {0} a day"),
  COMMAND_TAXES_TOTAL("&3&lTotal&7: {0} a day"),
  COMMAND_TAXES_TAX_COLLECTION("&3&lTax Collection&7: {0}"),
  COMMAND_TAXES_FOOTER("&a-------------------------"),
  COMMAND_BONUS_CLAIM_GIFT_SUCCESS("&aYou successfully gifted &6{0} &3{1} bonus claims&a!"),
  COMMAND_BONUS_CLAIM_GIFT_TARGET_SUCCESS("&aYou have been gifted &3{0} bonus claims &afrom the player &6{1}&a!"),
  COMMAND_BONUS_CLAIM_SUCCESS("&aYou currently have &3{0} bonus claims&a!"),
  COMMAND_PROFIT_TITLE("&a----- &7[ &2&lTown Profit &7] &a-----"),
  COMMAND_PROFIT_RENT("&3&lRent&7: {0} a day"),
  ...
  CHAT_SHOP_VARIABLE("&6[{0}Shop&6]"),
  CHAT_SHOP_VARIABLE_TITLE("{0}'s Shop"),
  CHAT_SHOP_VARIABLE_INFO("&6» &aClick to teleport to shop!"),
  ERROR_BONUS_CLAIM_GIFT_INSUFFICIENT_BONUS_CLAIMS("&cYou only have &3{0} &cbonus claims so you cant gift &3{1}&c."),
  ERROR_BONUS_CLAIM_GIFT_SELF("&cYou can't gift yourself bonus claims."),
  ...
  ERROR_CREATE_BLANK("&cThe name input was blank, please pick a name using normal letters and numbers."),
  ...
  ERROR_AUTO_CLAIM_TOWN_DOES_NOT_EXIST("&cYou're no longer apart of a town, auto claim has been toggled {0}&c."),
  ERROR_AUTO_CLAIM_NO_PERMISSION("&cYou no longer have permission to auto claim. Auto claim has been toggled {0}&c."),
  ...
  ERROR_ROLE_CREATE_BLANK("&cThe role name input was blank, please pick a role name using normal letters and numbers."),
