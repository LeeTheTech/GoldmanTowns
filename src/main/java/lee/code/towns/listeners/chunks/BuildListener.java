...
public class BuildListener implements Listener {
  ...
  public void onBuild(BuildEvent e) {
    ...
    if (result)
      e.getPlayer().sendActionBar(Lang.ERROR_LOCATION_PERMISSION.getComponent(new String[]{cacheManager.getChunkTownName(e.getLocation()), CoreUtil.capitalize(Flag.BUILD.name()), Lang.FALSE.getString()}));
  }
}
