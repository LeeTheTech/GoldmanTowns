...
public class PvEListener implements Listener {
  ...
  public void onPvE(PvEEvent e) {
    ...
    if (result)
      e.getAttacker().sendActionBar(Lang.ERROR_LOCATION_PERMISSION.getComponent(new String[]{cacheManager.getChunkTownName(e.getLocation()), Flag.PVE.name(), Lang.FALSE.getString()}));
  }
}
